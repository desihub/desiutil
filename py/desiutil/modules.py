...
def configure_module(product, version, product_root, working_dir=None, dev=False):
    ...
    if ((os.path.exists(os.path.join(working_dir, 'setup.py')) or
         os.path.exists(os.path.join(working_dir, 'setup.cfg')) or
         os.path.exists(os.path.join(working_dir, 'pyproject.toml'))) and
